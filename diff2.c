...
int main(int argc,char* argv[]){
    ...
    //Compte le nombre de ligne dans le fichier1
    ...
    //Compte le nombre de ligne dans le fichier2
    ...
    //On parcours les lignes tant qu'elles ne sont pas égales à NULL
    while( R1!= NULL && R2 != NULL){
        printf("Line N°%d \n Content : %s\n",nb_lignes_file1,ligne_lue);
        printf("Line N°%d \n Content : %s\n",nb_lignes_file2,ligne_lue2);
        i = 0;

        //On parcours les caractère des lignes actuelles et on les compares
